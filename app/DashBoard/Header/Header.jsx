        ...
        <div className="w-full flex items-center justify-end ms-auto md:justify-between gap-x-1 md:gap-x-3">
          <div className="hidden md:block">
            <div className="relative">
              ...
              <input
                type="text"
                className="py-2 ps-10 pe-16 block w-full bg-white border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                placeholder="Search"
              />
          ...
          <div className="flex flex-row items-center justify-end gap-1">
            ...
            <div className="hs-dropdown [--placement:bottom-right] relative inline-flex group">
              <button
              ...
              <div className="transition-[opacity,margin] duration group-hover:opacity-100 opacity-0 hidden group-hover:block group-hover:absolute group-hover:-right-3 group-hover:top-10  min-w-60 bg-white shadow-md rounded-lg mt-2 after:h-4 after:absolute after:-bottom-4 after:start-0 after:w-full before:h-4 before:absolute before:-top-4 before:start-0 before:w-full">

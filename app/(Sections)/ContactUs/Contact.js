      ...
      <section className="min-h-max">
        <div className="w-full flex items-center relative">
          ...
          <div className="min-h-max relative mx-auto pt-20 lg:max-w-7xl w-full px-5 sm:px-10 md:px-12 lg:px-5 text-center space-y-10">
            ...
            <h1 className="text-[#242A3D] mx-auto max-w-5xl font-semibold text-4xl/tight sm:text-5xl/tight lg:text-5xl/tight after:content-[url('/images/HeroLine.svg')] xl:lg:after:flex after:-my-12 after:mx-36 after:justify-end after:hidden items-center ">
              {ContactUs.title}
            </h1>
          ...
          <div className="max-w-2xl lg:max-w-7xl mx-auto">
            <div className="mt-12 grid items-center lg:grid-cols-2 gap-6 lg:gap-16">
              ...
              <div className="flex flex-col border rounded-xl p-4 sm:p-6 lg:p-8 dark:border-gray-700">
                <h2 className="mb-8 text-xl font-semibold text-[#242A3D] tracking-tight">
                  Fill up your information for a FREE quote
                </h2>
              ...
              <div className="divide-y divide-gray-200 dark:divide-gray-800">
                ...
                <a
                  target="_blank"
                  href="https://api.whatsapp.com/send?phone=447515058788&text=Hello,%20CDC%20I'm%20intrested%20Your%20Services..."

...
import { ABOUTFEA } from "@/app/data/data";
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-10 md:px-12 lg:px-5 flex flex-col gap-14">
        ...
        <div className="flex gap-12 lg:items-center">
          <div className="flex flex-1 flex-col gap-10">
            ...
            <Link
              href="/Team"
              className={`active:_wiggle hover:bg-[#242A3D] group border-[#242A3D] transition-all ease-in-out delay-100 border-2 text-[#242A3D] hover:text-white px-5 h-12 rounded-md w-max flex items-center gap-x-3 `}
            >
              Meet Our Team
              <svg

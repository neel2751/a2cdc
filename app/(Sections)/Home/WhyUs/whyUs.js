...
import { useImageContext } from "./whyData";
...
const WhyUs = () => {
  ...
  const { jsxWhyUs, image } = useImageContext();
  return (
    // <!-- Features -->
      ...
      <div className="relative p-6 md:p-16">
        ...
        <div className="relative z-10 lg:grid lg:grid-cols-12 lg:gap-16 lg:items-center">
          <div className="mb-10 lg:mb-0 lg:col-span-7 lg:col-start-8 lg:order-2">
            <motion.h2
              ref={body}
              style={{ opacity: scrollYProgress, x: y }}
              className="text-xl text-[#242A3D] font-semibold sm:text-3xl"
            >

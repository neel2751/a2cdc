  ...
  return (
    <div data-custom-class="body">
          ...
          <strong>
            <span style={{ fontSize: "15px" }}>
              <span data-custom-class="subtitle">
                Last updated
                <bdt className="question">May 18, 2024</bdt>
              </span>
            </span>
          </strong>
        </span>
      ...
      <div style={{ lineHeight: "1.5" }}>
        <span style={{ color: "rgb(127, 127, 127)" }}>
          ...
          <span style={{ color: "rgb(0, 58, 250)", fontSize: "15px" }}>
            <span data-custom-class="body_text">
              <bdt className="question">https://cdc.construction</bdt>
            </span>
          </span>
          <span style={{ color: "rgb(89, 89, 89)", fontSize: "15px" }}>
            <span data-custom-class="body_text">
        ...
        <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
          <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
            <span data-custom-class="body_text">
              ...
              the table below (please note that the specific{" "}
            </span>
            <span data-custom-class="body_text">
                    ...
                    >
                      ...
                      >
                        <span
                          style={{ color: "#8b93a7", wordBreak: "break-all" }}
                        >
                          Used by Facebook to collect a unique browser and user
                          ID, used for targeted advertising.
                        </span>
                      </td>
                    </tr>
                    <tr
          ...
          <span style={{ color: "rgb(89, 89, 89)", fontSize: "15px" }}>
            ...
            <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
              <span data-custom-class="body_text">
                ...
                tiny graphics files that contain a unique identifier that
                enables us to recognize when someone has visited our Website
                <bdt className="block-component"></bdt>
                or opened an email including them
                <bdt className="statement-end-if-in-editor"></bdt>. This allows
      ...
      <div style={{ lineHeight: "1.5" }}>
        <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
          <bdt className="question">
            <span data-custom-class="body_text">595a Cranbrook Road</span>
          </bdt>
          <span data-custom-class="body_text">
            <bdt className="block-component"></bdt>
          </span>
      ...
      <div style={{ lineHeight: "1.5" }}>
        <span data-custom-class="body_text">
          <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
            <bdt className="question">illford</bdt>
            <bdt className="block-component"></bdt>,
            <bdt className="question">London</bdt>
            <bdt className="statement-end-if-in-editor"></bdt>
            <bdt className="block-component"></bdt>
            <bdt className="question">IG2 6JZ</bdt>
            <bdt className="statement-end-if-in-editor"></bdt>
            <bdt className="block-component"></bdt>
            <bdt className="block-component"></bdt>
          </span>
      ...
      <div style={{ lineHeight: "1.5" }}>
        <span data-custom-class="body_text">
          <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
            <bdt className="statement-end-if-in-editor">
              Phone:
              <bdt className="question">020-8004-3327</bdt>
            </bdt>
          </span>
        </span>
        <span data-custom-class="body_text">
